...
from travels_api.db.models import Customer, Vehicle, Booking, Admin, Payment, VehicleAvailability, BookingStatus, VehicleType, TripType
from travels_api.core.security import get_password_hash, verify_password
...
async def create_payment(
    ...
    from datetime import datetime
    from travels_api.db.models import PaymentStatus, PaymentMethod
...
async def update_payment_status(
    ...
    from travels_api.db.models import PaymentStatus
    from datetime import datetime
