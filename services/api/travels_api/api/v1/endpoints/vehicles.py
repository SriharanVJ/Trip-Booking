...
from travels_api.db.crud import get_vehicles, get_vehicle_by_id, get_available_vehicles_for_dates
from travels_api.db.models import VehicleType
...
async def check_vehicle_availability_endpoint(
    ...
    try:
        from travels_api.db.crud import check_vehicle_availability
