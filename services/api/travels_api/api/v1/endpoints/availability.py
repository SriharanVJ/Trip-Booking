...
from travels_api.db.crud import get_vehicles, check_vehicle_availability, get_available_vehicles_for_dates
...
async def check_vehicle_availability_detail(
    ...
    try:
        from travels_api.db.crud import get_vehicle_by_id
