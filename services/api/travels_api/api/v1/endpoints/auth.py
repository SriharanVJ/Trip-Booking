...
from travels_api.db.session import get_db
from travels_api.db.crud import create_customer, authenticate_customer, get_customer_by_email, authenticate_admin
from travels_api.core.security import create_access_token
from travels_api.schemas.user import CustomerCreate, CustomerLogin, CustomerResponse, AdminLogin, AdminResponse, Token
from travels_api.core.deps import get_current_user, get_current_admin
...
async def login(
    ...
    # Update last login
    from travels_api.db.crud import update_customer_login
