...
from travels_api.db.models import Vehicle, Booking, BookingStatus, VehicleType
from travels_api.core.deps import get_current_admin
from travels_api.schemas.user import AdminResponse
