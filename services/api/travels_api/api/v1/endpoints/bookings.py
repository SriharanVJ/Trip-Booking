...
from travels_api.db.crud import (
    create_booking,
    get_bookings,
    get_booking_by_id,
...
from travels_api.db.models import BookingStatus
from travels_api.services.pricing import pricing_service
from travels_api.schemas.vehicle import (
    BookingCreate,
    BookingResponse,
...
async def create_booking_endpoint(
    ...
    try:
        ...
        if not customer_id and booking_data.contact_phone:
            ...
            from travels_api.db.crud import get_customer_by_phone, create_customer
