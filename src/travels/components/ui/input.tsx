    ...
    return (
      <div className="relative">
        {label && (
          <label
            className={cn(
              'absolute left-4 top-1/2 -translate-y-1/2 px-2 bg-black/50 backdrop-blur-xs text-sm transition-all duration-300 pointer-events-none z-10',
              isFocused || hasValue
        ...
        <div className="relative">
          ...
          <input
            type={type}
            className={cn(
              'flex h-12 w-full rounded-xl border-2 bg-black/50 backdrop-blur-xs px-4 py-3 text-sm ring-offset-background',
              'text-warm-white placeholder:text-warm-white-dark/30',
              'focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gold/20',
