  ...
  'group relative flex items-center gap-3 w-full p-4 rounded-2xl shadow-premium-lg transition-all duration-300 pointer-events-auto',
  {
    variants: {
      variant: {
        ...
        success: 'bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 border-2 border-green-200 dark:border-green-800',
        destructive: 'bg-linear-to-br from-red-50 to-rose-50 dark:from-red-950 dark:to-rose-950 border-2 border-red-200 dark:border-red-800',
        warning: 'bg-linear-to-br from-orange-50 to-amber-50 dark:from-orange-950 dark:to-amber-950 border-2 border-orange-200 dark:border-orange-800',
        info: 'bg-linear-to-br from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950 border-2 border-blue-200 dark:border-blue-800',
      },
    },
    defaultVariants: {
      variant: 'default',
