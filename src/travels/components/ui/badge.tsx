...
const badgeVariants = cva(
  'inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-semibold transition-all duration-200 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
        ...
        gradient: 'border-transparent bg-linear-to-r from-primary to-accent text-white hover:opacity-90',
        ...
        premium: 'border-amber-200 dark:border-amber-800 bg-linear-to-r from-amber-50 to-yellow-50 dark:from-amber-950 dark:to-yellow-950 text-amber-700 dark:text-amber-400',
      },
      size: {
