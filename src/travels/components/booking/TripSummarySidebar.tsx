    ...
    <Card className="glass-luxury-card border-gold/20 sticky top-4">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-start gap-4 pb-4 border-b border-gold/10">
          <div className="w-20 h-16 rounded-lg bg-charcoal-dark overflow-hidden shrink-0">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3">
            <Calendar className="h-4 w-4 text-gold/70 shrink-0 mt-0.5" />
            <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start gap-3">
            <Users className="h-4 w-4 text-gold/70 shrink-0 mt-0.5" />
