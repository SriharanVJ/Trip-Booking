...
import { Label } from '@travels/components/ui/label'
import { RadioGroup, RadioGroupItem } from '@travels/components/ui/radio-group'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@travels/components/ui/select'
...
import { Popover, PopoverContent, PopoverTrigger } from '@travels/components/ui/popover'
import { Calendar as CalendarComponent } from '@travels/components/ui/calendar'
import { cn, formatCurrency } from '@travels/lib/utils'
import type { TripType, Location, MultiCityStop } from '@travels/types/booking'
