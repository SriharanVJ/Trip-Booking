...
import { cn, formatDate, formatTime, formatCurrency } from '@travels/lib/utils'
import type { BookingResponse, TripDetails, CustomerInfo } from '@travels/types/booking'
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link to="/travels/bookings" className="flex-1">
          ...
          <Link to="/travels" className="block mt-4 text-center">
