...
import { routesApi } from '@travels/lib/api'
          ...
          >
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute top-4 left-4">
                <div className="bg-white/90 backdrop-blur-xs rounded-full px-4 py-2 shadow-lg">
              ...
              <div className="absolute bottom-4 right-4">
                <div className="bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-xl px-4 py-2 shadow-lg">
