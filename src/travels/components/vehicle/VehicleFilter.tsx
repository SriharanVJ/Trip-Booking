...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from '@travels/components/ui/collapsible'
import {
  Select,
  SelectContent,
  SelectItem,
...
import type { VehicleFilterParams, VehicleType, VehicleAmenity } from '@travels/types'
  ...
  return (
    <>
      ...
      <div className="glass-luxury-card rounded-3xl overflow-hidden border-gold/20 shadow-luxury-lg">
        {/* Header */}
        <div className="p-6 border-b border-gold/10 bg-linear-to-r from-gold/5 to-transparent">
              ...
              {amenities.map((amenity) => (
                ...
                >
                  <Checkbox
                    ...
                    className="border-gold/30 data-[state=checked]:bg-gold data-[state=checked]:border-gold shrink-0"
                  />
                  <Label
