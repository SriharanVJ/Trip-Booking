...
import { ScrollArea } from '@travels/components/ui/scroll-area'
import {
  TrendingUp,
  TrendingDown,
  Users,
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Button className="gap-2 bg-linear-to-r from-primary to-accent">
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                ...
                <div className={cn(
                  ...
                  <div className={cn(
                    'w-10 h-10 rounded-xl bg-linear-to-r flex items-center justify-center',
                    stat.gradient
                  )}>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {quickActions.map((action) => (
              <Link key={action.label} to={travelsHref(action.href)}>
                <Button
                  variant="outline"
                ...
                >
                  <div className={cn(
                    'p-3 rounded-xl bg-linear-to-r transition-transform group-hover:scale-110',
                    action.color
                  )}>
                ...
                {topRoutes.map((route, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-linear-to-br from-primary/20 to-accent/20 flex items-center justify-center font-bold text-primary">
                        #{index + 1}
                      </div>
                      <div>
