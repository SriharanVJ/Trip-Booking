...
import { Car, Menu, X, User, LogIn, ChevronDown, Bell, Settings, LogOut, Crown, LayoutGrid } from 'lucide-react'
...
import { travelsHref } from '@travels/lib/navigation'
...
export function Header() {
  ...
  return (
    ...
    >
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-24 items-center justify-between">
          ...
          <div className="flex items-center">
            <Link to="/travels" className="flex items-center gap-4 group">
              <div className="relative">
                <div className="absolute inset-0 bg-linear-to-br from-gold to-gold-light rounded-xl blur-xl opacity-40 group-hover:opacity-60 transition-opacity duration-500"></div>
                <div className="relative w-14 h-14 bg-linear-to-br from-gold to-gold-dark rounded-xl flex items-center justify-center shadow-gold-lg group-hover:shadow-gold-xl transition-all group-hover:scale-105 duration-500 border border-gold/30">
          ...
          <div className="hidden lg:flex items-center gap-2">
            {navigation.map((item) => (
              ...
              >
                ...
                <span className={cn(
                  'absolute bottom-0 left-1/2 -translate-x-1/2 h-[2px] bg-linear-to-r from-transparent via-gold to-transparent',
          ...
          <div className="hidden md:flex items-center gap-4">
            {/* Back to unified landing */}
            <Link to="/" className="flex items-center gap-1.5 text-sm font-medium text-warm-white-dark/70 hover:text-gold transition-colors">
              <LayoutGrid className="h-4 w-4" />
              Apps
            </Link>

            {/* Admin Link */}
            <Link to="/travels/admin">
              <Button
                variant="ghost"
                className={cn(
            ...
            <div className="relative">
              ...
              >
                <div className="w-9 h-9 rounded-full bg-linear-to-br from-gold/20 to-gold/10 flex items-center justify-center border border-gold/30">
            ...
            <Link to="/travels/register">
              <Button className={cn(
                'h-11 px-6 rounded-xl font-semibold bg-linear-to-r from-gold to-gold-light',
            ...
            <div className="mt-6 pt-6 border-t border-gold/10 space-y-3 px-5">
              <Link to="/" className="block">
                <Button variant="ghost" className={cn(
                  'w-full justify-start h-13 rounded-xl gap-2',
                  'text-warm-white-dark/70 hover:text-gold hover:bg-gold/5'
                )}>
                  <LayoutGrid className="h-4 w-4" />
                  All Apps
              ...
              <Link to="/travels/admin" className="block">
                <Button variant="ghost" className={cn(
              ...
              <Link to="/travels/login" className="block">
                <Button
                  variant="outline"
                  className={cn(
              ...
              <Link to="/travels/register" className="block">
                <Button className={cn(
                  'w-full h-13 rounded-xl font-semibold',
                  'bg-linear-to-r from-gold to-gold-light text-black',
      ...
      {/* Progress Bar - Gold */}
      <div className="h-[2px] bg-linear-to-r from-transparent via-gold/50 to-transparent overflow-hidden">
        <div className="h-full w-1/3 bg-linear-to-r from-gold/20 via-gold/40 to-gold/20 animate-shimmer-gold"></div>
      </div>
    </header>
  )
}
