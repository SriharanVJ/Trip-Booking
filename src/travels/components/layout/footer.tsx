...
import { deadRoute } from '@travels/lib/navigation'
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/travels/routes" className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="w-1 h-1 bg-blue-500 rounded-full"></span>
                  All Routes
                </Link>
              </li>
              <li>
                <Link to={deadRoute('/travels/about')} className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="w-1 h-1 bg-blue-500 rounded-full"></span>
                  About Us
                </Link>
              </li>
              <li>
                <Link to={deadRoute('/travels/contact')} className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="w-1 h-1 bg-blue-500 rounded-full"></span>
                  Contact
                </Link>
              </li>
              <li>
                <Link to={deadRoute('/travels/faq')} className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="w-1 h-1 bg-blue-500 rounded-full"></span>
                  FAQ
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/travels/vehicles" search={{ type: 'car' }} className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="text-lg">🚗</span>
                  Cars
                </Link>
              </li>
              <li>
                <Link to="/travels/vehicles" search={{ type: 'traveller' }} className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="text-lg">🚌</span>
                  Travellers
                </Link>
              </li>
              <li>
                <Link to="/travels/vehicles" search={{ type: 'coach' }} className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="text-lg">🚐</span>
                  Coaches
                </Link>
              </li>
              <li>
                <Link to="/travels/vehicles" search={{ type: 'bus' }} className="hover:text-blue-400 transition-colors text-sm flex items-center gap-2">
                  <span className="text-lg">🚌</span>
                  Buses
                </Link>
              </li>
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          ...
          <div className="flex items-center gap-6">
            <Link to={deadRoute('/travels/terms')} className="hover:text-white transition-colors">
              Terms of Service
            </Link>
            <Link to={deadRoute('/travels/privacy')} className="hover:text-white transition-colors">
              Privacy Policy
            </Link>
            <Link to={deadRoute('/travels/refund')} className="hover:text-white transition-colors">
              Refund Policy
            </Link>
          </div>
        </div>
