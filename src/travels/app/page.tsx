...
// Lazy imports for code splitting - load heavy components only when needed
const BusSearch = lazy(() => import('@travels/components/vehicle/bus-search').then(mod => ({ default: mod.BusSearch })))

const FeaturedRoutes = lazy(() => import('@travels/components/vehicle/featured-routes').then(mod => ({ default: mod.FeaturedRoutes })))
        ...
        <div className="relative container mx-auto px-4 py-24 md:py-32">
          ...
          >
            ...
            <div className="glass-luxury-card rounded-3xl p-8 md:p-12 shadow-luxury-lg max-w-4xl mx-auto border-gold-thick animate-scale-in-luxury" style={{ animationDelay: '0.4s' }}>
              <Suspense fallback={<div className="h-20 bg-charcoal-dark/30 rounded-2xl animate-pulse" />}>
                <BusSearch />
              </Suspense>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            ...
            <Button
              ...
              onClick={() => (window.location.href = '/travels/vehicles')}
            >
              View All Routes
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Button
              ...
              onClick={() => (window.location.href = '/travels/register')}
            >
              Join Membership
            </Button>
          </div>
