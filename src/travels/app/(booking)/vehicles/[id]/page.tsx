...
import { useParams, useSearchParams } from '@travels/lib/navigation'
import { useRouter } from '@travels/lib/navigation'
import { VehicleDetails, VehicleDetailsSkeleton } from '@travels/components/vehicle/VehicleDetails'
import { AvailabilityCalendar, generateSampleAvailability } from '@travels/components/vehicle/AvailabilityCalendar'
import { Card, CardContent } from '@travels/components/ui/card'
  ...
  return (
    <>
      ...
      <section className="relative py-16 border-t border-gold/10">
        <div className="absolute inset-0 bg-linear-to-b from-black to-charcoal-dark"></div>
      ...
      <section className="relative py-24 border-t border-gold/20">
        <div className="absolute inset-0 bg-linear-to-b from-charcoal-dark to-black">
          <div className="absolute inset-0 bg-gradient-luxury-mesh"></div>
        </div>
