...
import { VehicleCard, VehicleCardSkeleton } from '@travels/components/vehicle/VehicleCard'
import { Button } from '@travels/components/ui/button'
import { Input } from '@travels/components/ui/input'
...
import {
  ...
  PaginationNext,
  PaginationPrevious,
} from '@travels/components/ui/pagination'
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@travels/components/ui/select'
import type { Vehicle } from '@travels/types'
import { vehicleApi } from '@travels/lib/api'
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="relative overflow-hidden py-24 md:py-32 border-b border-gold/20">
        {/* Background Effects */}
        <div className="absolute inset-0 bg-linear-to-br from-black via-charcoal-dark to-black">
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Results Section */}
        {/* NOTE: the upstream Next.js source shipped with a missing opening
            <div> here (its closing tag remained, so the file never compiled).
            A neutral wrapper restores the balance without changing the DOM
            content of either app. */}
        <div>
                ...
                {paginatedVehicles.length > 0 ? (
                  ...
                  <div className="text-center py-24 animate-fade-in-up-luxury">
                    <div className="glass-luxury-card rounded-3xl p-12 max-w-lg mx-auto border-gold/20">
                      ...
                      <Button
                        className="bg-linear-to-r from-gold to-gold-light text-black hover:from-gold-light hover:to-gold font-display font-semibold rounded-xl shadow-gold-lg shimmer-gold"
                        onClick={() => {
                          setSearchQuery('')
                        }}
                      >
                                ...
                                <PaginationItem key={page}>
                                  <PaginationLink
                                    ...
                                    className={`rounded-xl min-w-[44px] ${
                                      page === currentPage
                                        ? 'bg-linear-to-r from-gold to-gold-light text-black font-semibold shadow-gold-lg'
                                        : 'hover:bg-gold/10 text-warm-white hover:text-gold cursor-pointer'
                                    }`}
                                  >
                                    {page}
      ...
      <section className="relative py-24 border-t border-gold/20">
        <div className="absolute inset-0 bg-linear-to-b from-black via-charcoal-dark to-black">
          <div className="absolute inset-0 bg-gradient-luxury-mesh"></div>
        </div>
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Button
                size="lg"
                className="h-14 px-8 bg-linear-to-r from-gold to-gold-light text-black hover:from-gold-light hover:to-gold font-display font-semibold rounded-xl shadow-gold-lg shimmer-gold"
              >
