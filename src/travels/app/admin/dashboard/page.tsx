...
import { vehicleApi, bookingApi } from '@travels/lib/api'
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Header */}
      <div className="bg-linear-to-r from-gold/20 to-gold/5 border-b border-gold/20">
      ...
      <div className="container mx-auto px-4 py-8">
        {loading ? (
          ...
          <Link to="/travels/admin/vehicles" className="block group">
          ...
          <Link to="/travels/admin/bookings" className="block group">
            <Card className="glass-luxury-card border-gold/20 h-full group-hover:border-gold/40 transition-colors cursor-pointer">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-gold">
          ...
          <Link to="/travels/admin/bookings" search={{ status: 'pending' }} className="block group">
            <Card className="glass-luxury-card border-gold/20 h-full group-hover:border-gold/40 transition-colors cursor-pointer">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-gold">
          ...
          <Link to={deadRoute('/travels/admin/reports')} className="block group">
            <Card className="glass-luxury-card border-gold/20 h-full group-hover:border-gold/40 transition-colors cursor-pointer">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-gold">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="glass-luxury-card border-gold/20">
            ...
            <CardContent className="space-y-3">
              <a href="/travels/admin/vehicles" className="block p-4 rounded-lg bg-gold/5 hover:bg-gold/10 border border-gold/20 transition-all">
                <div className="flex items-center gap-3">
              ...
              <a href="/travels/admin/bookings" className="block p-4 rounded-lg bg-gold/5 hover:bg-gold/10 border border-gold/20 transition-all">
                <div className="flex items-center gap-3">
          ...
          <Card className="glass-luxury-card border-gold/20">
            ...
            <CardContent className="space-y-3">
              <a href="/travels/admin/reports" className="block p-4 rounded-lg bg-gold/5 hover:bg-gold/10 border border-gold/20 transition-all">
                <div className="flex items-center gap-3">
              ...
              <a href="/travels/admin/settings" className="block p-4 rounded-lg bg-gold/5 hover:bg-gold/10 border border-gold/20 transition-all">
                <div className="flex items-center gap-3">
