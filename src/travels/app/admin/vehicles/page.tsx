...
import { getVehicleById } from '@travels/lib/api'
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link to="/travels/admin/dashboard">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="bg-black/50 border border-gold/20 rounded-lg px-3 py-2 text-sm text-warm-white placeholder:text-warm-white-dark/40 focus:outline-hidden focus:border-gold/50 w-full md:w-64"
                />
              </div>
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="bg-black/50 border border-gold/20 rounded-lg px-3 py-2 text-sm text-warm-white focus:outline-hidden focus:border-gold/50"
                >
            ...
            {vehicles.map((vehicle) => (
              <Card key={vehicle.id} className="glass-luxury-card border-gold/20 hover:border-gold/40 transition-colors group">
                <div className="relative h-48 overflow-hidden bg-black">
                  ...
                  {vehicle.rating && (
                    <div className="absolute top-3 right-3 flex items-center gap-1 bg-black/70 backdrop-blur-xs rounded-full px-2 py-1">
                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Link to={deadRoute(`/travels/admin/vehicles/${vehicle.id}`)} className="flex-1">
