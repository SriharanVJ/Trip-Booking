...
import { bookingApi, vehicleApi } from '@travels/lib/api'
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="bg-black/50 border border-gold/20 rounded-lg px-3 py-2 text-sm text-warm-white placeholder:text-warm-white-dark/40 focus:outline-hidden focus:border-gold/50 w-full md:w-80"
                />
              </div>
              <div className="flex items-center gap-2">
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                    ...
                    <div className="flex lg:flex-col gap-4 lg:w-64">
                      ...
                      <Link to={deadRoute(`/travels/admin/bookings/${booking.id}`)} className="lg:ml-auto">
